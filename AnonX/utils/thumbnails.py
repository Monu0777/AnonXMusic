...
from AnonX.config import MUSIC_BOT_NAME, YOUTUBE_IMG_URL
...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        draw.text((190, 650), f"Powered By: Deva Sir & Monu Gupta (@deva_mandal @Monu_Gupta_01)", (255, 255, 255), font=font)
        try:
            os.remove(f"cache/thumb{videoid}.png")
